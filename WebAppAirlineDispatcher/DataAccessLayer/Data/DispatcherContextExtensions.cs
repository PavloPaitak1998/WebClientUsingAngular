        ...
        public static void EnsureDatabaseSeeded(this DispatcherContext context)
        {
            ...
            if (!context.Pilots.Any())
            {
                context.Pilots.AddRange(new List<Pilot>
                    {
                        new Pilot{FirstName="Tom",LastName="Piton",BirthDate=DateTime.Parse("12.07.1998"),Experience=1,CrewId=1},
                        new Pilot{FirstName="Ted",LastName="Pen",BirthDate=DateTime.Parse("28.03.1990"),Experience=2,CrewId=2},
                        new Pilot{FirstName="Pavlo",LastName="Toden",BirthDate=DateTime.Parse("12.06.1994"),Experience=3,CrewId=3}
                    });
                context.SaveChanges();
            }
